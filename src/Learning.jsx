...
function LProject (params) {
 return <div class="">
    <p class="p-5 pb-3  center">Learning Projects</p>
 <div id="projectCarousel" class="carousel slide my-5" data-bs-ride="pause">
       ...
       <div class="col">
         ...
         <div class="card shadow-sm">
          ...
          <div class="card-body">
              ...
              <div class="icons ">
              {/* <!-- CSS icon from devicons --> */}
              <i class="fab devicon-css3-plain-wordmark colored"></i>
              {/* <!-- js icon from devicons --> */}
              <i class="fab devicon-javascript-plain colored m-2"></i>
                    <i class="fab devicon-postgresql-plain-wordmark colored"></i>
                    <i class="fab devicon-nodejs-plain-wordmark colored"></i>
                 {/* <!-- jquery icon from devicons --> */}
                    <i class=" fab devicon-express-original-wordmark colored"></i>
              </div>
     ...
     <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
       ...
       <div class="card shadow-sm">
          ...
          <div class="card-body">
              ...
              <div class="icons ">
              {/* <!-- HTML icon from devicons --> */}
              <i class="devicon-html5-plain-wordmark colored m-2"></i>
              {/* <!-- CSS icon from devicons --> */}
       ...
       {/* <!-- Repeat the structure of your cards --> */}
       <div class="col">
         {/* <!-- Card 2 --> */}
         <div class="card shadow-sm">
       ...
       <div class="col">
         ...
         <div class="card shadow-sm">
          ...
          <div class="card-body">
              ...
              <i class="fab devicon-css3-plain-wordmark colored m-2"></i>
              <i class="fab devicon-javascript-plain colored m-2"></i>
              <i class="devicon-jquery-plain-wordmark colored m-2"></i>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                </div>
       ...
       <div class="col">
         ...
         <div class="card shadow-sm">
          ...
          <div class="card-body">
              ...
              {/* <!-- js icon from devicons --> */}
              <i class="fab devicon-javascript-plain colored m-2"></i>
                    <img width={60} height={60} class="mb-1 pb-4" src="/pics/api.svg" alt="" />
                    <i class="fab devicon-nodejs-plain-wordmark colored"></i>
                 {/* <!-- jquery icon from devicons --> */}
                    <i class=" fab devicon-express-original-wordmark colored"></i>
              </div>
         ...
         {/* <!-- Add more slides here if you have more cards --> */}
   <div class="carousel-item">
     <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
       <div class="col">
         {/* <!-- Card 7 --> */}
         <div class="card shadow-sm">
          ...
          <div class="card-body">
              ...
              {/* <!-- js icon from devicons --> */}
              <i class="fab devicon-javascript-plain colored m-2"></i>
              <img width={60} class="pb-4 m-2" src="/pics/ejs.png" alt="" />
                    <i class="fab devicon-nodejs-plain-wordmark colored"></i>
                 {/* <!-- jquery icon from devicons --> */}
                    <i class=" fab devicon-express-original-wordmark colored"></i>
              </div>
 ...
 {/* <!-- Carousel controls --> */}
 <button class="carousel-control-prev m-0" type="button" data-bs-target="#projectCarousel" data-bs-slide="prev">
   <span class="carousel-control-prev-icon start" aria-hidden="true"></span>
   <span class="visually-hidden">Previous</span>
 </button>
 <button class="carousel-control-next m-0" type="button" data-bs-target="#projectCarousel" data-bs-slide="next">
